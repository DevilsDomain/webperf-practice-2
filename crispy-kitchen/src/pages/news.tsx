...
function news() {
  return (
     ...
     <><Navbar /><main>
              ...
              <div className="container">
                  <div className="row">
                      ...
                      <div className="col-lg-6 col-md-6 col-12">
                          <div className="news-thumb mb-4">
                              <Link href="/newsDetail">
                                  <Image src="/images/news/pablo-merchan-montes-Orz90t6o0e4-unsplash.jpg" className="img-fluid news-image" alt="" width={100} height={200} />
                              </Link>
                              ...
                              <div className="news-text-info news-text-info-large">
                                  ...
                                  <h5 className="news-title mt-2">
                                      <Link href="/newsDetail" className="news-title-link">How to make a healthy diet?</Link>
                                  </h5>
                              </div>
                          </div>
                      </div>
                      ...
                      <div className="col-lg-6 col-md-6 col-12">
                          <div className="news-thumb mb-4">
                              <Link href="/newsDetail">
                                  <Image src="/images/news/stefan-johnson-xIFbDeGcy44-unsplash.jpg" className="img-fluid news-image" alt="" width={100} height={200} />
                              </Link>
                              ...
                              <div className="news-text-info news-text-info-large">
                                  ...
                                  <h5 className="news-title mt-2">
                                      <Link href="newsDetail" className="news-title-link">Happy Living and happy eating tips</Link>
                                  </h5>
                              </div>
                          </div>
                      </div>
                      ...
                      <div className="col-lg-4 col-md-6 col-12">
                          <div className="news-thumb mb-4">
                              ...
                              <div className="news-text-info">
                                  ...
                                  <h5 className="news-title mt-2">
                                      <Link href="newsDetaill" className="news-title-link">How to run a sushi business?</Link>
                                  </h5>
                              </div>
                          </div>
                      </div>
      ...
      </main><footer className="site-footer section-padding">
